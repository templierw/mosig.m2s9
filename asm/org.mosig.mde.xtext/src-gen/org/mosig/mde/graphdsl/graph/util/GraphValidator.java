 ...
 */
package org.mosig.mde.graphdsl.graph.util;
 ...
 * <!-- end-user-doc -->
 * @see org.mosig.mde.graphdsl.graph.GraphPackage
 * @generated
 */
public class GraphValidator extends EObjectValidator {
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "org.mosig.mde.graphdsl.graph";
	...
	public boolean validateNode(Node node, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateNode_UniqueNode(node, diagnostics, context);
		if (result || diagnostics != null) result &= validateNode_Next(node, diagnostics, context);
		return result;
	}

	/**
	 * The cached validation expression for the UniqueNode constraint of '<em>Node</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected static final String NODE__UNIQUE_NODE__EEXPRESSION = "Node.allInstances()->forAll(n | n <> self implies n.name <> self.name)";

	/**
	 * Validates the UniqueNode constraint of '<em>Node</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateNode_UniqueNode(Node node, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(GraphPackage.Literals.NODE,
				 ...
				 "UniqueNode",
				 NODE__UNIQUE_NODE__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
	...
	/**
	 * The cached validation expression for the Next constraint of '<em>Node</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected static final String NODE__NEXT__EEXPRESSION = "self.next -> forAll(n | self.next->select(m | m = n)->size()=1)";

	/**
	 * Validates the Next constraint of '<em>Node</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateNode_Next(Node node, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(GraphPackage.Literals.NODE,
				 node,
