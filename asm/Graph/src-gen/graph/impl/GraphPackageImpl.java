...
public class GraphPackageImpl extends EPackageImpl implements GraphPackage {
	 ...
	 * @generated
	 */
	public EOperation getGraph__Validate() {
	...
	public void createPackageContents() {
		...
		createEOperation(graphEClass, GRAPH___VALIDATE);
	...
	public void initializePackageContents() {
		...
		initEReference(getGraph_TheNodes(), this.getNode(), null, "theNodes", null, 0, -1, Graph.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEOperation(getGraph__Validate(), ecorePackage.getEBoolean(), "Validate", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getNode_Next(), this.getNode(), this.getNode_Previous(), "next", null, 0, -1, Node.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNode_Previous(), this.getNode(), this.getNode_Next(), "previous", null, 0, -1, Node.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
