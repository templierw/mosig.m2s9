...
public class NodeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						GraphPackage.Literals.NODE__NAME, true, false, false,
	...
	protected void addNextPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Node_next_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Node_next_feature", "_UI_Node_type"),
						GraphPackage.Literals.NODE__NEXT, true, false, true, null, null, null));
	}
	...
	protected void addPreviousPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Node_previous_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Node_previous_feature", "_UI_Node_type"),
						GraphPackage.Literals.NODE__PREVIOUS, true, false, true, null, null, null));
	}
