...
public class InternalFamilyParser extends AbstractInternalAntlrParser {
    ...
    // InternalFamily.g:64:1: entryRuleModel returns [EObject current=null] : iv_ruleModel= ruleModel EOF ;
    public final EObject entryRuleModel() throws RecognitionException {
        ...
        try {
            // InternalFamily.g:64:46: (iv_ruleModel= ruleModel EOF )
            // InternalFamily.g:65:2: iv_ruleModel= ruleModel EOF
            {
    ...
    // InternalFamily.g:71:1: ruleModel returns [EObject current=null] : ( (lv_families_0_0= ruleFamily ) )* ;
    ...
    // InternalFamily.g:107:1: ruleFamily returns [EObject current=null] : (otherlv_0= 'Family' ( (lv_surname_1_0= RULE_ID ) ) otherlv_2= '{' (otherlv_3= 'Father' ( (otherlv_4= RULE_ID ) ) )? (otherlv_5= 'Mother' ( (otherlv_6= RULE_ID ) ) )? (otherlv_7= 'Sons' ( (lv_s_8_0= ruleMember ) )+ )? (otherlv_9= 'Daughters' ( (lv_d_10_0= ruleMember ) )+ )? otherlv_11= '}' ) ;
    public final EObject ruleFamily() throws RecognitionException {
        ...
        try {
            // InternalFamily.g:113:2: ( (otherlv_0= 'Family' ( (lv_surname_1_0= RULE_ID ) ) otherlv_2= '{' (otherlv_3= 'Father' ( (otherlv_4= RULE_ID ) ) )? (otherlv_5= 'Mother' ( (otherlv_6= RULE_ID ) ) )? (otherlv_7= 'Sons' ( (lv_s_8_0= ruleMember ) )+ )? (otherlv_9= 'Daughters' ( (lv_d_10_0= ruleMember ) )+ )? otherlv_11= '}' ) )
            // InternalFamily.g:114:2: (otherlv_0= 'Family' ( (lv_surname_1_0= RULE_ID ) ) otherlv_2= '{' (otherlv_3= 'Father' ( (otherlv_4= RULE_ID ) ) )? (otherlv_5= 'Mother' ( (otherlv_6= RULE_ID ) ) )? (otherlv_7= 'Sons' ( (lv_s_8_0= ruleMember ) )+ )? (otherlv_9= 'Daughters' ( (lv_d_10_0= ruleMember ) )+ )? otherlv_11= '}' )
            {
            // InternalFamily.g:114:2: (otherlv_0= 'Family' ( (lv_surname_1_0= RULE_ID ) ) otherlv_2= '{' (otherlv_3= 'Father' ( (otherlv_4= RULE_ID ) ) )? (otherlv_5= 'Mother' ( (otherlv_6= RULE_ID ) ) )? (otherlv_7= 'Sons' ( (lv_s_8_0= ruleMember ) )+ )? (otherlv_9= 'Daughters' ( (lv_d_10_0= ruleMember ) )+ )? otherlv_11= '}' )
            // InternalFamily.g:115:3: otherlv_0= 'Family' ( (lv_surname_1_0= RULE_ID ) ) otherlv_2= '{' (otherlv_3= 'Father' ( (otherlv_4= RULE_ID ) ) )? (otherlv_5= 'Mother' ( (otherlv_6= RULE_ID ) ) )? (otherlv_7= 'Sons' ( (lv_s_8_0= ruleMember ) )+ )? (otherlv_9= 'Daughters' ( (lv_d_10_0= ruleMember ) )+ )? otherlv_11= '}'
            {
            otherlv_0=(Token)match(input,11,FOLLOW_4); 

            			newLeafNode(otherlv_0, grammarAccess.getFamilyAccess().getFamilyKeyword_0());
            		
            // InternalFamily.g:119:3: ( (lv_surname_1_0= RULE_ID ) )
            // InternalFamily.g:120:4: (lv_surname_1_0= RULE_ID )
            {
            // InternalFamily.g:120:4: (lv_surname_1_0= RULE_ID )
            // InternalFamily.g:121:5: lv_surname_1_0= RULE_ID
            {
            lv_surname_1_0=(Token)match(input,RULE_ID,FOLLOW_5); 
            ...
            // InternalFamily.g:179:3: (otherlv_7= 'Sons' ( (lv_s_8_0= ruleMember ) )+ )?
            int alt5=2;
            ...
            switch (alt5) {
                case 1 :
                    // InternalFamily.g:180:4: otherlv_7= 'Sons' ( (lv_s_8_0= ruleMember ) )+
                    {
                    otherlv_7=(Token)match(input,15,FOLLOW_4); 

                    				newLeafNode(otherlv_7, grammarAccess.getFamilyAccess().getSonsKeyword_5_0());
                    			
                    // InternalFamily.g:184:4: ( (lv_s_8_0= ruleMember ) )+
                    int cnt4=0;
                    loop4:
                    do {
                        int alt4=2;
                        ...
                        switch (alt4) {
                    	case 1 :
                    	    // InternalFamily.g:185:5: (lv_s_8_0= ruleMember )
                    	    {
                    	    // InternalFamily.g:185:5: (lv_s_8_0= ruleMember )
                    	    // InternalFamily.g:186:6: lv_s_8_0= ruleMember
                    	    {
            ...
            // InternalFamily.g:204:3: (otherlv_9= 'Daughters' ( (lv_d_10_0= ruleMember ) )+ )?
            int alt7=2;
            ...
            switch (alt7) {
                case 1 :
                    ...
                    do {
                        ...
                        switch (alt6) {
                    	case 1 :
                    	    // InternalFamily.g:210:5: (lv_d_10_0= ruleMember )
                    	    {
                    	    // InternalFamily.g:210:5: (lv_d_10_0= ruleMember )
                    	    // InternalFamily.g:211:6: lv_d_10_0= ruleMember
                    	    {
