...
public class MyDslPackageImpl extends EPackageImpl implements MyDslPackage
{
   ...
   */
  @Override
  public EReference getClass_Ext()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(classEClass, CLASS__EXT);
  ...
  public void initializePackageContents()
  {
    ...
    simpleEClass.getESuperTypes().add(this.getType());
    ...
    initEReference(getClass_Ext(), this.getClass_(), null, "ext", null, 0, 1, org.xtext.example.mydsl.myDsl.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getClass_Features(), this.getFeature(), null, "features", null, 0, -1, org.xtext.example.mydsl.myDsl.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(featureEClass, Feature.class, "Feature", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getFeature_Visibility(), ecorePackage.getEString(), "visibility", null, 0, 1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
